...
// import LearnTabComponent from "../isLoggedInLearn/learnTabComponent";
import TabRouteComponent from "./tabRouteComponent";

function LearnMoreArticleTab() {
    ...
    <div>
      <div className="max-w-screen-2xl w-full flex m-auto border border-gray-50">
        ...
        <div className="ml-80 bg-white px-10 pt-14 w-full">
          <div>
            <TabRouteComponent active="articles" />
          </div>
                ...
                <div className="mt-8">
                  <div className="grid grid-cols-3 gap-6">
                    <div
                      ...
                      className="bg-white cursor-pointer border rounded-2xl border-gray-100 shadow relative"
                    >
...
export default LearnMoreArticleTab;
