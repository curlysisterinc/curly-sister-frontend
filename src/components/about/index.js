          ...
          <div className="border border-orange-100 relative">
            ...
            <div className="relative text-center w-1/2 m-auto py-24">
              ...
              <p className="text-white text-lg mt-6">
                Curly Sister is an <strong>affirming space</strong> where people
                can get trustworthy professional advice to help them accept
                their hair without damaging or harming their waves or curls.
              </p>
            </div>
          </div>
        </div>
        <div className=" px-10 pb-10 bg-orange-100">
          <div className="bg-orange-50 border border-orange-50">
            <p className="w-3/5 mx-auto my-14 text-center">
              ...
              people with wavy or curly hair to either learn to maintain and/or
              style their hair in its natural state. We’re also an ecosystem
              where <strong>people can join </strong>
