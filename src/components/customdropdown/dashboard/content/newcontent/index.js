  ...
  return (
    <DropDown content={<Content />}>
      <button
        ...
        className="cursor-pointer bg-purple-100 relative text-white h-10 font-BeatriceSemiBold text-sm flex justify-between items-center  rounded-full p-3  w-180"
      >
        New content
        <img
